...
const buttonVariants = cva(
  'group whitespace-nowrap focus-visible:outline-hidden inline-flex items-center justify-center has-[[data-arrow=true]]:justify-between whitespace-nowrap text-sm font-medium ring-offset-background transition-[color,box-shadow] disabled:pointer-events-none disabled:opacity-50 [&_svg]:shrink-0 cursor-pointer',
  {
    variants: {
      variant: {
        primary:
